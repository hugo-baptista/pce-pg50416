...
module.exports.newClinicalInfo = async (clinicalinfo_id, amd_date, bed, body_temp, systolic, diastolic, bpm, sato2, timestamp) => {
    try {
        let blood_press = {systolic, diastolic};
        let clinicalinfo = new ClinicalInfoSchema({clinicalinfo_id, amd_date, bed, body_temp, blood_press, bpm, sato2, timestamp});
